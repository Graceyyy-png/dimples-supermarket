...
connection =pymysql.connect(host='localhost',user='root',password='',database='chatu_db')
...
def home():
    ...
    return render_template('home.html', phones=phones, detergents=detergents,
       electronics=electronics, bags=bags)
